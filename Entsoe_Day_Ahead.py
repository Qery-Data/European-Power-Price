...
dw.update_chart(chart_id='TegsW', title='<b style="font-size:17px">Strømpris i Øst (NO1) ' + formatted_date +'</b>')
dw.publish_chart(chart_id='TegsW', display=False)
dw.update_chart(chart_id='jMqlH', title='<b style="font-size:17px">Strømpris i Øst (NO1) ' + formatted_date +'</b>')
dw.publish_chart(chart_id='jMqlH', display=False)
dw.update_chart(chart_id='CVUb6', title='<b style="font-size:17px">Strømpris i Øst (NO1) ' + formatted_date +'</b>')
dw.publish_chart(chart_id='CVUb6', display=False)
dw.update_chart(chart_id='wDNoM', title='<b style="font-size:17px">Strømpris i Øst (NO1) ' + formatted_date +'</b>')
